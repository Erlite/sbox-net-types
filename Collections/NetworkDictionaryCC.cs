...
namespace NetworkWrappers
{
    ...
    public class NetworkDictionaryCC<TKey, TValue> : NetworkClass, IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
        where TKey : class
        where TValue : class
    {
        ...
        #region Constructors
        public NetworkDictionaryCC()
        {
            _internalDictionary = new Dictionary<TKey, TValue>();
        }

        public NetworkDictionaryCC(int capacity)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(capacity);
        }

        public NetworkDictionaryCC(IEqualityComparer<TKey>? comparer) : this(0, comparer)
        {
        }

        public NetworkDictionaryCC(int capacity, IEqualityComparer<TKey>? comparer)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(capacity, comparer);
        }

        public NetworkDictionaryCC(IDictionary<TKey, TValue> dictionary) : this(dictionary, null)
        {
        }

        public NetworkDictionaryCC(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
            : this(dictionary?.Count ?? 0, comparer)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(dictionary, comparer);
        }

        public NetworkDictionaryCC(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null)
        {
        }

        public NetworkDictionaryCC(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer) :
