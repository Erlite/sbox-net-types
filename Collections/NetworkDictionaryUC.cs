...
namespace NetworkWrappers
{
    ...
    public class NetworkDictionaryUC<TKey, TValue> : NetworkClass, IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
        ...
        where TValue : class
    {
        ...
        #region Constructors
        public NetworkDictionaryUC()
        {
            _internalDictionary = new Dictionary<TKey, TValue>();
        }

        public NetworkDictionaryUC(int capacity)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(capacity);
        }

        public NetworkDictionaryUC(IEqualityComparer<TKey>? comparer) : this(0, comparer)
        {
        }

        public NetworkDictionaryUC(int capacity, IEqualityComparer<TKey>? comparer)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(capacity, comparer);
        }

        public NetworkDictionaryUC(IDictionary<TKey, TValue> dictionary) : this(dictionary, null)
        {
        }

        public NetworkDictionaryUC(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
            : this(dictionary?.Count ?? 0, comparer)
        {
            _internalDictionary = new Dictionary<TKey, TValue>(dictionary, comparer);
        }

        public NetworkDictionaryUC(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null)
        {
        }

        public NetworkDictionaryUC(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer) :
