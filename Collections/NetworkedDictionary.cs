...
namespace NetworkWrappers
{
	...
	public class NetworkedDictionary<TKey, TValue> : NetworkClass, IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
	{
		...
		public NetworkedDictionary( IEqualityComparer<TKey>? comparer ) : this( 0, comparer )
		{
		}

		public NetworkedDictionary( int capacity, IEqualityComparer<TKey>? comparer )
		{
			_internalDictionary = new Dictionary<TKey, TValue>( capacity, comparer );
		}

		public NetworkedDictionary( IDictionary<TKey, TValue> dictionary ) : this( dictionary, null )
		{
		}

		public NetworkedDictionary( IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer )
			: this( dictionary?.Count ?? 0, comparer )
		{
			_internalDictionary = new Dictionary<TKey, TValue>( dictionary, comparer );
		}

		public NetworkedDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection ) : this( collection, null )
		{
		}

		public NetworkedDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer ) :
		...
		{
			throw new InvalidOperationException( "This is not accessible outside of Dictionary, sorry!" );
		}

		public bool Remove( KeyValuePair<TKey, TValue> item )
		{
			throw new InvalidOperationException( "This is not accessible outside of Dictionary, please remove by key!" );
		}
