...
namespace NetworkWrappers
{
    ...
    public class NetworkValueList<T> : NetworkClass, IList<T>, IReadOnlyList<T> where T : unmanaged
    {
        ...
        public NetworkValueList(int capacity)
        {
            _internalList = new List<T>(capacity);
        }

        /// <inheritdoc cref="List{T}(IEnumerable{T})"/>
        public NetworkValueList(IEnumerable<T> collection)
        {
